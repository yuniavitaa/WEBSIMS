...
<div class="container text-center pt-5">
    ...
    <div class="container text-center pt-5">
        ...
        <div class="row mt-4">
            <div class="col-md-3">
                <div class="card">
                    <img src="assets/img/jaringan.png" class="card-img-top" alt="Partner 1">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="assets/img/teknologi.png" class="card-img-top" alt="Partner 2">
                    <div class="card-body equal-height">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="assets/img/support.png" class="card-img-top" alt="Partner 3">
                    <div class="card-body equal-height">
            ...
            <div class="col-md-3">
                <div class="card">
                    <img src="assets/img/inovasi.png" class="card-img-top" alt="Partner 4">
                    <div class="card-body equal-height">
