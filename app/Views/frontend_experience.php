...
<div class="container-fluid government-section" style="max-height: 512px; overflow: hidden;">
    <div class="row mb-5 align-items-center">
        ...
        <div class="col-md-6 p-0">
            <img src="<?= base_url ('assets/img/exmedia.png') ?>" alt="Government Image" style="object-fit: cover;" >
        </div>
    </div>
</div>
<br>
...
<div class=" container">
            <div class="row">
                <div class="col d-flex justify-content-center">
                    <img src="<?= base_url ('assets/img/exgev.png') ?>" alt="" style="width: 80%;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container left-section" >
            <div class="row mb-5 align-items-center" >
                <div class="col-md-6 p-0">
                    <div>
                        <img src="<?= base_url ('assets/img/exsarjito.png') ?>" alt="Government Image" class="img-fluid government-image">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex justify-content-center">
                    <img src="<?= base_url ('assets/img/exlogosarjito.png') ?>" alt="" style="width: 20%;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container government-section" style="max-height: 512px; overflow: hidden;">
            <div class="row mb-5 align-items-center">
                ...
                <div class="col-md-6 p-0">
                    <img src="<?= base_url ('assets/img/exisp.png') ?>" alt="Government Image" style="object-fit: cover;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex flex-column align-items-center">
                    <img src="<?= base_url ('assets/img/exlogoisp.png') ?>" alt="" style="width: 60%;">
                    <img src="<?= base_url ('assets/img/exlogoisp2.png') ?>" alt="" style="width: 60%;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container left-section">
            <div class="row mb-5 align-items-center">
                <div class="col-md-6 p-0">
                    <div>
                        <img src="<?= base_url ('assets/img/exhotel.png')?>" alt="Government Image" class="img-fluid government-image">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex justify-content-center">
                    <img src="<?= base_url ('assets/img/exlogohotel.png') ?>" alt="" style="width: 50%;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container government-section"style="max-height: 512px; overflow: hidden;">
            <div class="row mb-5 align-items-center">
                ...
                <div class="col-md-6 p-0">
                    <img src="<?= base_url ('assets/img/exaprt.png') ?> " alt="Government Image" style="object-fit: cover;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex flex-column align-items-center">
                    <img src="<?= base_url ('assets/img/exlogoapart.png') ?>" alt="" style="width: 20%;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container left-section">
            <div class="row mb-5 align-items-center">
                <div class="col-md-6 p-0">
                    <div>
                        <img src="<?= base_url ('assets/img/exedu.png') ?>" alt="Government Image" class="img-fluid government-image">
                    </div>
                </div>
                <div class="col-md-6 flex-column justify-content-start" style="padding-left: 40px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex justify-content-center">
                    <img src="<?= base_url ('assets/img/exlogoedu.png') ?>" alt="" style="width: 50%;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container-fluid government-section" style="max-height: 512px; overflow: hidden;">
            <div class="row mb-5 align-items-center">
                ...
                <div class="col-md-6 p-0">
                    <img src="<?= base_url ('assets/img/exbank.png') ?>" alt="Government Image" style="object-fit: cover;">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex flex-column align-items-center">
                    <img src="<?= base_url ('assets/img/exlogobank.png') ?>" alt="" style="width: 60%;">
                </div>
            </div>
        </div>
        <br>
